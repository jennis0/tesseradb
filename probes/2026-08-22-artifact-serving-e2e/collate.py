...
def main() -> None:
    ...
    if fixture_report.exists():
        ...
        write_csv(out / f"{tier}-fixture.csv", [{
            ...
            "materialise_seconds": report["materialise"].get("seconds"),
            "materialise_peak_rss_bytes": report["materialise"].get("peak_rss_bytes"),
            "materialise_reused": report["materialise"].get("reused", False),
            "memory_budget": report["build"].get("memory_budget"),
            "dropped_layers": ",".join(report["build"].get("dropped_layers") or []),
            ...
            "materialise_reused", "memory_budget", "dropped_layers",
