...
**Date:** 2026-08-20, corrected 2026-08-21 · **Harness:** `cargo run --release --bin
artifact_serving_scale` · **Host:** WSL2, 47 GB RAM, 12 cores · **Driver:**
...
> record is worth more than a tidy summary — but read this list first and treat each figure as a
> **ceiling on a claim rather than a measurement** until [`run-remeasure.sh`](run-remeasure.sh) has
> been run. The design document carries the full story; one line each here.
>
