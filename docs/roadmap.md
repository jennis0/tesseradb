...
(decision 0062), the operand on `/v1/viewport`, the per-column operator list on `/v1/meta`, and a
...
producers, composed as a boolean tree **evaluated inside the candidate** (decision 0062) — which is
