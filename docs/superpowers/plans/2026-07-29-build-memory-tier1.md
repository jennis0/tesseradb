...
**Files:**
- Create: `docs/superpowers/plans/bench-baselines/2026-07-29-build-memory.md`
...
Create `docs/superpowers/plans/bench-baselines/2026-07-29-build-memory.md` with a table of scale, peak RSS before, peak RSS after, ratio, and elapsed time before/after — plus one line stating whether 250M now completes on a 39 GB box, and the extrapolated 10⁹ figure with the arithmetic shown.

- [ ] **Step 4: Commit**

```bash
git add docs/superpowers/plans/bench-baselines/2026-07-29-build-memory.md
