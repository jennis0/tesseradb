...
**Companion to** `2026-07-31-client-interaction-architecture-design.md` (§8.3's MVT adapter, §8.6's
tile-addressed alias) and `2026-08-01-caching-architecture-design.md`, whose **S5** is this
document's cache.
