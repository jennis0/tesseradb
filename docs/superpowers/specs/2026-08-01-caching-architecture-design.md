...
**Companion to** `2026-07-31-client-interaction-architecture-design.md`, whose §3, §5, §5.1, §6.2
...
- **Removals come from the server's own ledger** — the deny set's immediate-publication rule and
  the flush/epoch ledger. No client claim is load-bearing here, which is the security-relevant
  guarantee.
