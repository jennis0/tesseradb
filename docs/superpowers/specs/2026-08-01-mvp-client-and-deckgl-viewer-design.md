...
**Parent:** `2026-07-31-client-interaction-architecture-design.md`, which owns the client
...
`2026-07-31-client-interaction-architecture-design.md`. Owner rulings recorded in place: all
