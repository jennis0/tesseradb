...
**This is almost certainly the tail** `docs/design-memos/2026-07-30-tail-attribution.md` chased and
...
`docs/superpowers/plans/2026-07-30-selection-route-chooser.md`. Win 1 does not block it and does
not pre-empt it.
