...
Follow-on to `docs/design-memos/2026-07-30-tail-discrimination.md`, which refuted cold page
faults as the cause of the ~38–47 ms p99−p50 gap seen across k=50..1000 in
`docs/superpowers/plans/bench-baselines/2026-07-29-1e9-k-sweep.json`. This memo tests the leading
...
(Random-sweep rows are the existing baseline, `docs/superpowers/plans/bench-baselines/
