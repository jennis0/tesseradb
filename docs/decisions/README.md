...
- [0135](0135-a-generating-set-is-the-callers-claim-i8-withdrawn.md): I8 withdrawn — a generating set is the caller's claim, changeable at ingest in either direction; containment is against the declared set inside the mask; C7 generalised, C12 is the whole story
