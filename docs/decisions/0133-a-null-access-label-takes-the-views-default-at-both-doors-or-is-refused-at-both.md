...
**Date:** 2026-09-06 · **Status:** Settled (owner ruling) · Built 2026-09-06 (contracts §3.4 r80; `bundle_format` 6: every view and group record carries `point_default`, which `/control/ingest` reads; the `source` route's fill and refusal stay deferred, `configuration.md` §1)
