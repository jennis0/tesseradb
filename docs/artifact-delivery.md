...
| **5** Trees, levels and the cut | in progress (2026-08-17, `artifacts/stage-4`) | a passing child sits beneath a failing parent under the proportional criterion and never under the absolute one, and two budgets agree on every artifact both return | — |
