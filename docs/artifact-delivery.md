...
against 68.5 ms. It is a latency choice with no disclosure content: both compute the same
quantities from inside `M_auth`, and each wins on its own side of the crossover.
