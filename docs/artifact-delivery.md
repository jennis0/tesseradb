...
([decision 0091](decisions/0091-build-is-ingest-into-an-empty-database.md)); ⊘ what remains there is
minting, so an unknown key is still refused rather than creating the artifact it names. What does not exist yet beyond that is
