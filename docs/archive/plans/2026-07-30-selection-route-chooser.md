> **ARCHIVED 2026-08-01 — SUPERSEDED IN PART. Its Task 1 landed inside the density-sampling plan; Tasks 2+ did not and were not carried forward.**
>
...
`docs/evidence/memos/2026-07-30-priority-as-identity-prefix.md`, which shares Task 1's
call site.
