> **ARCHIVED 2026-08-01 — PARTIALLY SUPERSEDED, as its own banner already recorded. Phases 0 and 1 are done; Phase 2 was superseded by docs/design/caching.md; Task 6 was deferred.**
>
...
>   `docs/design/caching.md`. The underlay is no longer a
