...
**View switching is designed and in build** (2026-09-01): [`design/view-switching.md`](design/view-switching.md)
...
canvas generator. Steps **V1** (the store) and **V2** (the components) are in build on two
worktrees off `client/view-switching`, whose seam commit carries the interface both build against;
**V3** (the transition, and the `positions` verb) waits on the ruling in the design's §10. Until V1
merges, a two-view corpus still opens on its first view and the arXiv rung's `pca64` is
