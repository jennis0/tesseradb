...
- **configuration.md**: every key of `corpus.toml` and `tessera.toml`, its type, default and what refuses. Extracted from `design/configuration.md` §1, §5, §7 and §8 and from `crates/tessera-config`.
