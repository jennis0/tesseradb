...
**Date:** 2026-08-31
**Status:** Normative (r27) — **the drill-down is the whole permitted picture of one point**
(r27, 2026-09-01, owner ruling; `contracts.md` §3.2 r68). `POST /v1/items/{tessera_id}` names the
...
served" is superseded. *(A concurrent branch was also at r26; if it lands first this becomes r28.)*
