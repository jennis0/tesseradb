...
| [`views-and-multi-table.md`](views-and-multi-table.md) | Provisional | Views alone, r5: named coordinate systems over one entity space, view **groups** whose members are created at ingest, the index two groups can share, and attribute scope. Signature grouping is back in the deferred sketch. Rewritten 2026-08-30, **not yet reviewed** |
