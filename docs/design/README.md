...
| [`dag-hierarchies.md`](dag-hierarchies.md) | Normative (r3) | The `dag` hierarchy kind — a child naming several parents — and the rule that a withheld artifact is not in the viewer's tree; decision 0117. ⊘ Not yet built, marked at each claim |
