...
| [`dag-hierarchies.md`](dag-hierarchies.md) | Normative (r3) | The `dag` hierarchy kind — a child naming several parents — and the rule that a withheld artifact is not in the viewer's tree; decision 0117. Built server-side 2026-09-01; ⊘ no corpus declares the kind yet |
