...
| [`compaction.md`](compaction.md) | Provisional | The fold: what retires at it, what it carries forward, the prefix rewrite and the `CURRENT` flip, and reclamation. Answers write-path §8's obligation list — **nothing in it is built** |
