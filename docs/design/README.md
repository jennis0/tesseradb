...
| [`views.md`](views.md) | Provisional | r5 — renamed from `views-and-multi-table.md`: named coordinate systems over one entity space, view **groups** whose members are created at ingest, members shared between groups, and attribute scope. Signature grouping is back in the deferred sketch. Rewritten 2026-08-30, **not yet reviewed** |
