...
**Date:** 2026-08-01
**Status:** Provisional — under review. Graduated into the corpus 2026-08-01. Split out of `client-interaction.md` §9.1. **To become normative:** owner review of the taxonomy, and its consequences for Appendix C folded into the leak register — it generalises two sections of the specification, and an unreviewed framework must not become something the specification defers to.
**Split from** `client-interaction.md` §9.1, which had grown to a quarter of that document while answering a question that is not a client question.
