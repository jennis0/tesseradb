...
- **r55** — **the drill-down names an item's satisfied labels** (2026-08-31, **owner ruling**,
  ...
  structural: the serving path holds only the descriptors the session's credential presented, so
