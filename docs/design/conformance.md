...
**Status:** Draft r5 — r4 plus decisions 0027, 0028 and 0030: I5's oracle route left open, the pair relation as a differential prerequisite, and what the canary comparison's reliance on determinism actually rests on (Appendix R)
