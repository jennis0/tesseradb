...
**Status:** Draft r18 — **the gate is driven against an oracle** (r18, 2026-08-31; `views.md` §6):
...
against a real flush; and a scoped `text` or rendered family, which has no serving artefact for an
