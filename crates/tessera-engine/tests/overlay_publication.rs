...
fn a_flush_manifest_carries_the_deny_state_at_publication() {
    ...
    engine
        .accept_change(source_id_key(7), suppressed, ChangeOp::Suppress, None)
...
fn an_unsuppress_is_absent_from_the_next_manifest() {
    ...
    engine
        .accept_change(source_id_key(7), entity, ChangeOp::Unsuppress, None)
        .expect("accepted");
    ingest(&engine, "ext-2");
...
fn a_delete_reaches_tombstones_and_a_suppress_reaches_deny() {
    ...
    engine
        .accept_change(source_id_key(11), deleted, ChangeOp::Delete, None)
        .expect("accepted");
    engine
        .accept_change(source_id_key(12), suppressed, ChangeOp::Suppress, None)
        .expect("accepted");
