...
use tessera_engine::{
    AcceptError, DeclaredScalar, Projection, ScalarType, ViewMeta, Vocabularies, VocabularyKind,
...
fn resolve_view<'a>(view: Option<&str>, views: &'a [ViewMeta]) -> Result<&'a ViewMeta, ApiError> {
    match view {
