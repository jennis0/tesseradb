...
Every figure quoted on a plate comes from `probes/` and `docs/evidence/`; re-run a campaign before
relying on one. Plates 15–17 (slices, clusters, labels) describe designs that are not built and
say so on the plate.
