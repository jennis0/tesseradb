...
verb to block is checked by the binary rather than mirrored here (python-sdk.md §4). What this
module owes that arrangement is a writer whose output is the document the caller would have
written by hand: block order preserved, one table per block, and every value spelled the way
`configuration.md` §1 spells it.
