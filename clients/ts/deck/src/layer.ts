...
export type OutlineDatum = {
  ...
  opened: boolean;
  hovered: boolean;
  /** The wire's `rung` — the resolution the artifact is drawn at (contracts §3.2 r43). */
  rung: number;
...
export function outlineData(a: ArtifactsProjection, o: OutlineOptions): OutlineDatum[] {
  ...
  // The wire's `rung` orders parents first (contracts §3.2 r43): the declared level on a levelled
 ...
 *
 * The number compared is the wire's `rung` (contracts §3.2 r43): the declared level on a levelled
