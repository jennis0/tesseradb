...
const artifact = (id: bigint, parentId: bigint | null, level = 0): Artifact => ({layer: 'clusters', tesseraId: id, key: `c-${id}`, maskedCount: 1n, centroid: null, box: null, hull: null, content: [], parentId, level, matched: null});
