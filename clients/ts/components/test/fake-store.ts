...
export function fakeStore(overrides: Partial<Projections> = {}): FakeStore {
  const projections: Projections = {
    ...
    tiles: {tiles: []},
    artifacts: {layer: null, layers: [], served: [], lineage: servedLineage([]), status: 'idle', refusal: null, version: 0, table: new SessionArtifactTable(), servedOrdinals: new Set(), hulls: new Map(), colours: new Map(), palette: 'positional', coverage: {current: 0, stale: 0}},
